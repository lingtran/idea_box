...
var patchData = function patchData(element, updateContent) {
...
function updateQualityCall(ideaId, patchQualityData, errorMessage) {
  $.ajax({
    ...
    failure: function failure(req, status, err) {
...
var patchQualityData = function patchQualityData(inputName, ideaId, currentQuality) {
